...
export const MyPatientsPage = () => {
  ...
  const { user } = useData();
  const { myPatients, myRequests, handleDeletePatient, handleAcceptPatient } = usePsychologist();
                  ...
                  <div className="flex flex-wrap gap-4 justify-between items-center">
                    <div className="flex gap-4 content-center">
                      <button
                        ...
                        onClick={async (e) =>
                          await handleDeletePatient(e, patient)
                        }
                      >
                  ...
                  <div className="flex flex-wrap gap-4 justify-between items-center">
                    ...
                    <div className="flex gap-4 content-center">
                      <button
                        className="text-secondary-base hover:text-primary-dark"
                        onClick={async (e) =>
                          await handleAcceptPatient(e, patient)
                        }
                      >
